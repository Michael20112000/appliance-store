...
- [x] **CHAT-10**: Юзер бачить лічильник непрочитаних повідомлень від адміна на FAB/кнопці відкриття чату
- [x] **CHAT-11**: При відкритті нового чату юзеру пропонуються suggested messages: одне контекстне по поточному товару (якщо є) + 2–3 загальних (графік роботи, адреса тощо)
