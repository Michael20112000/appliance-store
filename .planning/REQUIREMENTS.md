...
- [ ] **AUTH-03**: Для додавання в кошик, checkout і чату потрібен вхід
...
- [ ] **CHAT-01**: Користувач може відкрити чат з магазином (з товару або кабінету)
- [ ] **CHAT-02**: Повідомлення доставляються в реальному часі (Pusher або еквівалент)
- [ ] **CHAT-03**: Історія чату зберігається в БД і доступна після перезавантаження
- [ ] **CHAT-04**: Адмін бачить список діалогів і може відповідати покупцям
...
- [ ] **ADM-05**: Адмін може керувати чатами з покупцями в одному інтерфейсі
