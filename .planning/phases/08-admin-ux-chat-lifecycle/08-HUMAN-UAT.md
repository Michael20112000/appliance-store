...
number: 1
name: Desktop sidebar collapse and navigation
expected: |
  Sidebar stays visible on md+; SidebarRail collapses to icons; Замовлення, Чати (badge), Категорії navigate correctly
