...
export const DEMO_STATUS_PRODUCTS = [
  {
    ...
    quantity: 0,
    categorySlug: "kholodylnyky",
    description: "Розпроданий товар (qty 0) для тестів CAT-07.",
  },
  {
    ...
    quantity: 0,
    categorySlug: "kholodylnyky",
    description: "Другий розпроданий товар для тестів.",
  },
  {
    slug: "lg-kholodylnyk-draft-demo-draft",
    title: "LG Холодильник out-of-stock demo",
    brand: "LG",
    priceUah: 6500,
    condition: "LIKE_NEW" as const,
    quantity: 0,
    categorySlug: "kholodylnyky",
    description: "Немає в наявності — не показується в публічному каталозі.",
  },
] as const;
